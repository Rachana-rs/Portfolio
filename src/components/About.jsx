      ...
      <div className='bg-black h-full w-full text-white sm:flex sm:justify-around about py-12 mt-8 overflow-x-hidden' id='about'>
        <div className='flex flex-col justify-around'>
          <div className='sm:px-16 px-2'>
            ...
            <p className='mt-3 mb-6 text-[17px] max-w-3xl leading-[30px]'>👨‍💻 Hi, I'm Rachana Ravi Shekar, a soon to be 2025 graduate🎓 with a passion for deriving meaningful insights from data and solving complex business problems.
              <br /> 
              <br />
